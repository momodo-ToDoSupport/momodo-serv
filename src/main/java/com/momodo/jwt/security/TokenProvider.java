...
public class TokenProvider {
    ...
    // 토큰을 받아 클레인을 만들고 권한정보를 빼서 시큐리티 유저객체를 만들어 Authentication 객체 반환
    public Authentication getAuthentication(String token) {
        ...
        UserApp findUserApp = userAppRepository.findByUserId(claims.getSubject().trim()).orElse(null);

        authorities = Collections.singletonList(new SimpleGrantedAuthority(findUserApp.getRoles().getCode()));
